...
public class PepsApplication {
    ...
    private static void addPermissionForAdmin(List<Permission> permissions){
        permissions.add(new Permission("BuyingFrame.edit"));
        permissions.add(new Permission("BuyingFrame.list"));
        permissions.add(new Permission("BuyingFrame.view"));
        permissions.add(new Permission("BuyingFrame.add"));
        permissions.add(new Permission("BuyingFrame.delete"));
    }
